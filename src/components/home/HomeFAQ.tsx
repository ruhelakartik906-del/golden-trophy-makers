      ...
      <div className="grid lg:grid-cols-2 gap-14 items-start">
        <AnimatedSection direction="left">
          ...
          <p className="text-muted-foreground text-sm">
            Can't find your answer? <a href="/contact" className="text-primary font-medium hover:underline">Contact us</a> or message us on <a href="https://wa.me/919315879315" target="_blank" rel="noopener noreferrer" className="text-primary font-medium hover:underline">WhatsApp</a>.
          </p>
        </AnimatedSection>
